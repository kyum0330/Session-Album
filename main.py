...
3. 분위기 기반 비주얼 매칭: 차분하고 서정적인 곡이라면 은은하고 깊이 있는 이목구비를, 트렌디하고 리드미컬한 곡이라면 선이 또렷하고 매혹적인 이목구비를 적용해 줘. 표정 역시 곡의 핵심 감정에 맞춰 과하지 않게(예: 옅은 미소, 무심한 듯 시크한 눈빛 등) 조율해 줘.
4. 감성 시각화 및 의상: 곡의 날씨와 계절감에 완벽히 들어맞는 세련된 '꾸안꾸(Effortless Cool)' 패션을 입혀주고, 장르에서 느껴지는 온도와 핵심 감정선을 조명과 색감으로 생생하게 시각화해 줘. 인물보다 사물이 어울리는 은유적 곡이라면 인물을 배제해도 좋아.
